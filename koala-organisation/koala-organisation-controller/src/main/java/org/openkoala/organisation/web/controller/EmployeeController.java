...
public class EmployeeController extends BaseController {
	...
	public Page<EmployeeDTO> pagingQuery(@RequestParam("page") int page, @RequestParam("pagesize") int pagesize, EmployeeDTO example) {
	...
	public Page<EmployeeDTO> pagingQueryByOrganization(@RequestParam("page") int page, @RequestParam("pagesize") int pagesize, EmployeeDTO example, Long organizationId, boolean queryAllChildren) {
		if (organizationId == 0) {
